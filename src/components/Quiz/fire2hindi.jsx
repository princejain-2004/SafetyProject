...
const quizSetsHindi = [
  [
    {
      question: "बिजली के आग पर पानी क्यों नहीं डालना चाहिए?",
      options: [
        {
          text: "यह आग को और बड़ा बना देता है",
          isCorrect: true,
          feedback: "सही! पानी बिजली का संचालन करता है और आग को बढ़ा सकता है या झटका दे सकता है।",
        },
        {
          text: "यह पानी की बर्बादी है",
          isCorrect: false,
          feedback: "गलत। मुख्य खतरा बिजली है, पानी की बर्बादी नहीं। फिर प्रयास करें।",
        },
        {
          text: "यह बहुत धीमा है",
          isCorrect: false,
          feedback: "गलत। मुख्य कारण सुरक्षा है, गति नहीं। फिर प्रयास करें।",
        },
      ],
    },
    {
      question: "आग के समय दरवाज़ा खोलने से पहले क्या करना चाहिए?",
      options: [
        {
          text: "हाथ से छूकर जांचें कि यह गर्म है या नहीं",
          isCorrect: true,
          feedback: "सही! दरवाज़े को पहले महसूस करना सुरक्षित रास्ता खोजने में मदद करता है।",
        },
        {
          text: "जल्दी खोलें",
          isCorrect: false,
          feedback: "गलत। बहुत जल्दी खोलना खतरनाक हो सकता है। फिर प्रयास करें।",
        },
        {
          text: "तोड़ दें",
          isCorrect: false,
          feedback: "गलत। बिना जांच के दरवाजा तोड़ना जोखिम भरा है। फिर प्रयास करें।",
        },
      ],
    },
  ],
...
export default function FireQuiz2hindi() {
