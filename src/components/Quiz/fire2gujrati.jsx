...
const quizSetsGujarati = [
  [
    {
      question: "ઇલેક્ટ્રિકલ આગ પર પાણી કેમ નાં પાડવું જોઈએ?",
      options: [
        {
          text: "આગ ને વધારે મોટું બનાવે છે",
          isCorrect: true,
          feedback: "સાચું! પાણી વીજળીનું પ્રવાહ કરે છે અને આગ વધારે અથવા વીજ ઝટકો આપી શકે છે.",
        },
        {
          text: "પાણી બગાડે છે",
          isCorrect: false,
          feedback: "ખોટું. મુખ્ય જોખમ વીજળી છે, પાણી બગાડવાનું નથી. ફરી પ્રયાસ કરો.",
        },
        {
          text: "ખૂબ ધીમી છે",
          isCorrect: false,
          feedback: "ખોટું. મુખ્ય કારણ સલામતી છે, ગતિ નથી. ફરી પ્રયાસ કરો.",
        },
      ],
    },
    {
      question: "આગ દરમિયાન દરવાજું ખોલવા પહેલાં શું કરવું જોઈએ?",
      options: [
        {
          text: "ગરમ છે કે નહીં તે જોવા માટે તેને સ્પર્શ કરો",
          isCorrect: true,
          feedback: "સાચું! પહેલા દરવાજાને સ્પર્શ કરવું તમને સુરક્ષિત માર્ગ શોધવામાં મદદ કરે છે.",
        },
        {
          text: "ઝડપથી ખોલો",
          isCorrect: false,
          feedback: "ખોટું. બહુ ઝડપથી ખોલવું જોખમી છે. ફરી પ્રયાસ કરો.",
        },
        {
          text: "તોડો",
          isCorrect: false,
          feedback: "ખોટું. તપાસ કર્યા વિના દરવાજું તોડવું જોખમી છે. ફરી પ્રયાસ કરો.",
        },
      ],
    },
  ],
...
export default function FireQuiz2gujrati() {
